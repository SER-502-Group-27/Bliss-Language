"""
Parser for the Bliss programming language.

Leveraging PLY's yacc module, this parser file translates a sequence of tokens generated by lexer.py into an Abstract Syntax Tree (AST). It defines the grammar rules of Bliss, including expressions, control flows, and function definitions, reflecting the language's syntax. The parser handles error detection, providing feedback for syntax errors, and integrates with the lexer to ensure accurate parsing of the source code.
"""
