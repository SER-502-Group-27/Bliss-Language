...
_lr_productions = [
    ...
    ("expression -> INTEGER", "expression", 1, "p_expression_number", "parse.py", 145),
    ("expression -> FLOAT", "expression", 1, "p_expression_number", "parse.py", 146),
    (
        "expression -> IDENTIFIER",
        "expression",
        1,
    ...
    ("expression -> STRING", "expression", 1, "p_expression_string", "parse.py", 160),
    ("expression -> BOOLEAN", "expression", 1, "p_expression_boolean", "parse.py", 167),
    (
        "expression -> MINUS expression",
        "expression",
        2,
    ...
    ("slice -> expression COLON", "slice", 2, "p_slice_start", "parse.py", 251),
    ("slice -> COLON COLON expression", "slice", 3, "p_slice_step", "parse.py", 258),
    ("slice -> COLON expression", "slice", 2, "p_slice_stop", "parse.py", 265),
    ("slice -> COLON", "slice", 1, "p_slice_empty", "parse.py", 272),
    ("slice -> expression", "slice", 1, "p_simple_index", "parse.py", 279),
    (
        "expression -> RANGE LPAREN range_args RPAREN",
        "expression",
        4,
    ...
    ("range_args -> expression", "range_args", 1, "p_range_args_one", "parse.py", 307),
    (
        "control_flow -> if_statement",
        "control_flow",
        1,
    ...
    ("block -> INDENT statements OUTDENT", "block", 3, "p_block", "parse.py", 355),
    (
        "function_definition -> DEF IDENTIFIER LPAREN params RPAREN COLON block",
        "function_definition",
        7,
    ...
    ("params -> params COMMA IDENTIFIER", "params", 3, "p_params", "parse.py", 369),
    ("params -> IDENTIFIER", "params", 1, "p_params", "parse.py", 370),
    ("params -> empty", "params", 1, "p_params", "parse.py", 371),
    ...
    ("arguments -> expression", "arguments", 1, "p_arguments", "parse.py", 396),
    ("arguments -> empty", "arguments", 1, "p_arguments", "parse.py", 397),
]
