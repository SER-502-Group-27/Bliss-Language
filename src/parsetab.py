...
_lr_signature = "ADD_ASSIGN AND ASSIGN BOOLEAN BREAK COLON CONTINUE DEDENT DIVIDE DIV_ASSIGN ELIF ELSE EQUAL FOR GREATER_EQUAL GREATER_THAN IDENTIFIER IF IN INDENT INTEGER LESS_EQUAL LESS_THAN LPAREN MINUS MODULO MOD_ASSIGN MUL_ASSIGN NOT NOT_EQUAL NUMBER OR PLUS PRINT RANGE RPAREN STRING SUB_ASSIGN TIMES WHILEstatement : expressionstatement : IDENTIFIER ASSIGN expression\n    statement : IDENTIFIER ADD_ASSIGN expression\n              | IDENTIFIER SUB_ASSIGN expression\n              | IDENTIFIER MUL_ASSIGN expression\n              | IDENTIFIER DIV_ASSIGN expression\n              | IDENTIFIER MOD_ASSIGN expression\n    expression : IDENTIFIER\n    expression : expression PLUS term\n               | expression MINUS term\n               | term\n    \n    term : term TIMES factor\n         | term DIVIDE factor\n         | term MODULO factor\n         | factor\n    \n    factor : NUMBER\n           | IDENTIFIER\n           | LPAREN expression RPAREN\n    "
