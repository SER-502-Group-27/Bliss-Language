...
_lr_productions = [
    ...
    ("program -> statements", "program", 1, "p_program", "parse.py", 46),
    (
        "statements -> statements statement",
        "statements",
        2,
    ...
    ("statements -> statement", "statements", 1, "p_statements", "parse.py", 54),
    ("statement -> assignment", "statement", 1, "p_statement", "parse.py", 65),
    ("statement -> expression", "statement", 1, "p_statement", "parse.py", 66),
    ("statement -> control_flow", "statement", 1, "p_statement", "parse.py", 67),
    ("statement -> function_definition", "statement", 1, "p_statement", "parse.py", 68),
    (
    ...
    ("expression -> INTEGER", "expression", 1, "p_expression_number", "parse.py", 103),
    ("expression -> FLOAT", "expression", 1, "p_expression_number", "parse.py", 104),
    (
        "expression -> IDENTIFIER",
        "expression",
        1,
    ...
    ("expression -> BOOLEAN", "expression", 1, "p_expression_boolean", "parse.py", 125),
    (
        "expression -> MINUS expression",
        "expression",
        2,
    ...
    ("slice -> expression COLON", "slice", 2, "p_slice_start", "parse.py", 202),
    ("slice -> COLON COLON expression", "slice", 3, "p_slice_step", "parse.py", 209),
    ("slice -> COLON expression", "slice", 2, "p_slice_stop", "parse.py", 216),
    ("slice -> COLON", "slice", 1, "p_slice_empty", "parse.py", 223),
    ("slice -> expression", "slice", 1, "p_simple_index", "parse.py", 230),
    (
        "expression -> RANGE LPAREN range_args RPAREN",
        "expression",
        4,
    ...
    ("range_args -> expression", "range_args", 1, "p_range_args_one", "parse.py", 258),
    (
        "control_flow -> if_statement",
        "control_flow",
        1,
    ...
    ("block -> INDENT statements OUTDENT", "block", 3, "p_block", "parse.py", 299),
    (
        "function_definition -> DEF IDENTIFIER LPAREN params RPAREN COLON block",
        "function_definition",
        7,
    ...
    ("params -> params COMMA IDENTIFIER", "params", 3, "p_params", "parse.py", 312),
    ("params -> IDENTIFIER", "params", 1, "p_params", "parse.py", 313),
    ("params -> empty", "params", 1, "p_params", "parse.py", 314),
    ("empty -> <empty>", "empty", 0, "p_empty", "parse.py", 323),
    (
        "expression -> IDENTIFIER LPAREN arguments RPAREN",
        "expression",
        4,
    ...
    ("arguments -> expression", "arguments", 1, "p_arguments", "parse.py", 336),
    ("arguments -> empty", "arguments", 1, "p_arguments", "parse.py", 337),
]
